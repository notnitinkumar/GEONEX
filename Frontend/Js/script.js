...
//   });
// }
const iitr = document.querySelector(".iitrlogo");
if (iitr) {
  iitr.addEventListener("click", function () {
    window.open("https://www.iitr.ac.in/", "_blank", "noopener noreferrer");
  });
}
const esc=document.querySelector(".ESClogo");
if(esc){
  esc.addEventListener("click", function(){
    window.open("https://es.iitr.ac.in/", "_blank", "noopener noreferrer");
  });
}
...
feedbackForm.addEventListener("click", function () {
  ...
  window.open(
    "https://forms.gle/hC2yyxk1n5M1MZK79",
    "_blank",
    "noopener noreferrer",
  );
});
